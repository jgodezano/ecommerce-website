...
export function createSchema(db: Database.Database) {
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS products (
      ...
      usage_rating TEXT NOT NULL DEFAULT 'light',
      finish_style TEXT DEFAULT '',
      indoor_outdoor TEXT NOT NULL DEFAULT 'both',
      drainage_suitable INTEGER NOT NULL DEFAULT 1,
      heavy_load_suitable INTEGER NOT NULL DEFAULT 0,
  ...
  const migrations: [string, string, string][] = [
    ...
    ["products", "recommendation_tags", "ALTER TABLE products ADD COLUMN recommendation_tags TEXT NOT NULL DEFAULT '[]'"],
    ["products", "recommended_projects", "ALTER TABLE products ADD COLUMN recommended_projects TEXT NOT NULL DEFAULT '[]'"],
    ["products", "usage_rating", "ALTER TABLE products ADD COLUMN usage_rating TEXT NOT NULL DEFAULT 'light'"],
    ["products", "finish_style", "ALTER TABLE products ADD COLUMN finish_style TEXT DEFAULT ''"],
    ["products", "indoor_outdoor", "ALTER TABLE products ADD COLUMN indoor_outdoor TEXT NOT NULL DEFAULT 'both'"],
    ["products", "drainage_suitable", "ALTER TABLE products ADD COLUMN drainage_suitable INTEGER NOT NULL DEFAULT 1"],
    ["products", "heavy_load_suitable", "ALTER TABLE products ADD COLUMN heavy_load_suitable INTEGER NOT NULL DEFAULT 0"],
    ["products", "color_family", "ALTER TABLE products ADD COLUMN color_family TEXT DEFAULT ''"],
