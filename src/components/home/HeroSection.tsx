...
const slides = [
  {
    title: "Calculate Your Material Requirements",
    subtitle: "Enter your project area and get an estimated material requirement and quotation for rocks, minerals, and related services.",
    cta: "Get My Estimate",
    href: "/estimator",
    cta2: "Browse Materials",
    href2: "/categories/raw-crystals",
    accent: "from-primary-500 to-primary-600",
    bg: "bg-gradient-to-r",
    image: "💎",
  },
  {
    title: "Wholesale Material Estimates",
    subtitle: "Get a configurable material estimate for landscaping, pathways, decorative projects, and wholesale requirements.",
